...
```json
{
  "hooks": {
    "Stop": [
      {
        "type": "command",
        "command": "powershell -File .claude/hooks/detect-corrections.ps1 -UserMessage \"$CLAUDE_USER_MESSAGE\""
      }
    ]
  }
}
...
| `suggest_reflect` | Continue but suggest reflection |
...
for learning in learnings:
    ...
    elif learning.type == "anti-pattern":
