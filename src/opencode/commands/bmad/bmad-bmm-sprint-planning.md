...
description: "Kick off implementation by producing the sprint plan the delivery agents will follow in sequence for the active stories."
---

# /bmad-bmm-sprint-planning

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-bmm-sprint-planning`.
...
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/4-implementation/sprint-planning/workflow.yaml`
- Preferred agent: Bob (Scrum Master)
- Mode / options: Create Mode
- Output lane: `current_story_dir`
- Expected outputs: sprint plan|sprint status
- Required checkpoint: yes
- Summary: Kick off implementation by producing the sprint plan the delivery agents will follow in sequence for the active stories.
