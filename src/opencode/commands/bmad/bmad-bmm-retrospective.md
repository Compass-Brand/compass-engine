...
description: "Optional at epic end: review completed work, lessons learned, and readiness for the next epic."
---

# /bmad-bmm-retrospective

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-bmm-retrospective`.
...
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/4-implementation/retrospective/workflow.yaml`
- Preferred agent: Bob (Scrum Master)
- Mode / options: Create Mode
- Output lane: `current_retrospectives_dir`
- Expected outputs: retrospective
- Summary: Optional at epic end: review completed work, lessons learned, and readiness for the next epic.
