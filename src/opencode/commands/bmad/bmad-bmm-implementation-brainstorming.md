---
name: bmad-bmm-implementation-brainstorming
description: "Implementation-focused ideation for the active phase and sprint execution."
---

# /bmad-bmm-implementation-brainstorming

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-bmm-implementation-brainstorming`.
...
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/4-implementation/implementation-brainstorming/workflow.md`
- Preferred agent: Mary (Business Analyst)
- Mode / options: Create Mode
- Output lane: `current_detailed_brainstorming_dir`
- Expected outputs: implementation brainstorming session
- Summary: Implementation-focused ideation for the active phase and sprint execution.
