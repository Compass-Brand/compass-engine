...
description: "If review finds issues, route back to Dev Story; if approved, continue through test review and traceability or advance to the next story."
---

# /bmad-bmm-code-review

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-bmm-code-review`.

## Scope

- Covered phases: implementation
- Primary agents: Amelia (Developer Agent)
...
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/4-implementation/code-review/workflow.yaml`
- Preferred agent: Amelia (Developer Agent)
- Mode / options: Create Mode
- Output lane: `current_evidence_dir`
- Expected outputs: code review findings
- Summary: If review finds issues, route back to Dev Story; if approved, continue through test review and traceability or advance to the next story.
