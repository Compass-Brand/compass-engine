...
description: "Story cycle start: prepare the next story in the sprint plan or a specifically requested story, then route through validation, ATDD, development, automation, and review."
---

# /bmad-bmm-create-story

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-bmm-create-story`.
...
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/4-implementation/create-story/workflow.yaml`
- Preferred agent: Bob (Scrum Master)
- Mode / options: Create Mode
- Output lane: `current_story_dir`
- Expected outputs: story
- Required checkpoint: yes
- Summary: Story cycle start: prepare the next story in the sprint plan or a specifically requested story, then route through validation, ATDD, development, automation, and review.
...
- Output lane: `current_story_dir`
- Expected outputs: story validation report
- Summary: Validate story readiness and completeness before development work begins.
