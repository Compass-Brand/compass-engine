...
description: "TEA insert: coverage traceability and gate decision for story or release scope."
---

# /bmad-tea-testarch-trace

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-tea-testarch-trace`.
...
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/testarch/trace/workflow.yaml`
- Preferred agent: Murat (Master Test Architect and Quality Advisor)
- Mode / options: Create Mode
- Output lane: `current_evidence_dir`
- Expected outputs: traceability matrix|gate decision
- Summary: TEA insert: coverage traceability and gate decision for story or release scope.
