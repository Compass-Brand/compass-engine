...
description: "Execute story implementation tasks and tests, then hand off to automation and review."
---

# /bmad-bmm-dev-story

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-bmm-dev-story`.
...
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/4-implementation/dev-story/workflow.yaml`
- Preferred agent: Amelia (Developer Agent)
- Mode / options: Create Mode
- Output lane: `current_story_dir`
- Expected outputs: story implementation
- Required checkpoint: yes
- Summary: Execute story implementation tasks and tests, then hand off to automation and review.
