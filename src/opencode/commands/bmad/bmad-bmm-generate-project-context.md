...
description: "Generate or refresh the lean project-context artifact for the active roadmap slice or brownfield repo state."
---

# /bmad-bmm-generate-project-context

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-bmm-generate-project-context`.
...
- Phase: `anytime`
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/generate-project-context/workflow.md`
- Preferred agent: Mary (Business Analyst)
- Mode / options: Create Mode
- Output lane: `current_project_context_dir`
- Expected outputs: project context
- Summary: Generate or refresh the lean project-context artifact for the active roadmap slice or brownfield repo state.
