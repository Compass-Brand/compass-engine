---
name: bmad-bmm-phase-closeout
description: "Close the active phase: archive the current snapshot, capture lessons, and refresh the next-phase scaffold."
---

# /bmad-bmm-phase-closeout

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-bmm-phase-closeout`.
...
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/0-governance/phase-closeout/workflow.md`
- Preferred agent: Bob (Scrum Master)
- Mode / options: Create Mode
- Output lane: `planning_previous`
- Expected outputs: phase closeout report|phase snapshot|lessons
- Summary: Close the active phase: archive the current snapshot, capture lessons, and refresh the next-phase scaffold.
