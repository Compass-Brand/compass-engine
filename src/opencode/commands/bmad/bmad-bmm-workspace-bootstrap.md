---
name: bmad-bmm-workspace-bootstrap
description: "Bootstrap selected repos from a workspace or orchestration root into the Compass BMAD planning and docs structure using safe migration rules."
---

# /bmad-bmm-workspace-bootstrap

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-bmm-workspace-bootstrap`.
...
- Phase: `anytime`
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/planning/workspace-bootstrap/workflow.yaml`
- Preferred agent: Mary (Business Analyst)
- Mode / options: Create Mode
- Output lane: `planning_root`
- Expected outputs: workspace bootstrap report|bootstrap selection|topology proposal
- Summary: Bootstrap selected repos from a workspace or orchestration root into the Compass BMAD planning and docs structure using safe migration rules.
