...
description: "TEA insert: generate failing tests before implementation begins."
---

# /bmad-tea-testarch-atdd

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-tea-testarch-atdd`.
...
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/testarch/atdd/workflow.yaml`
...
- Expected outputs: atdd tests
- Summary: TEA insert: generate failing tests before implementation begins.
