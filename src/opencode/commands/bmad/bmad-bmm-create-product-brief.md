...
description: "Create the high-level product brief that anchors the roadmap and later slice-level planning."
---

# /bmad-bmm-create-product-brief

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-bmm-create-product-brief`.
...
- Phase: `1-analysis`
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/1-analysis/create-product-brief/workflow.md`
- Preferred agent: Mary (Business Analyst)
- Mode / options: Create Mode
- Output lane: `roadmap_product_brief_dir`
- Expected outputs: product brief
- Summary: Create the high-level product brief that anchors the roadmap and later slice-level planning.
