...
Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-bmm-market-research`.
...
- Phase: `1-analysis`
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/1-analysis/research/workflow-market-research.md`
- Preferred agent: Mary (Business Analyst)
- Mode / options: Create Mode
- Output lane: `roadmap_market_research_dir`
- Expected outputs: research documents
- Summary: Market analysis, competitive landscape, customer needs, and trends.
