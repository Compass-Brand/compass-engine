...
description: "Quick one-off specs for small changes, utilities, and brownfield additions to well-established patterns without extensive planning."
---

# /bmad-bmm-quick-spec

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-bmm-quick-spec`.
...
- Phase: `anytime`
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/bmad-quick-flow/quick-spec/workflow.md`
- Preferred agent: Barry (Quick Flow Solo Dev)
- Mode / options: Create Mode
- Output lane: `current_architecture_dir`
- Expected outputs: tech spec
- Summary: Quick one-off specs for small changes, utilities, and brownfield additions to well-established patterns without extensive planning.
