...
description: "Review prose for clarity, tone, and communication issues. Use after drafting to polish written content."
---

# /bmad-editorial-review-prose

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-editorial-review-prose`.
...
- Phase: `anytime`
- Module: `core`
- Workflow: `_bmad/modules/custom/core/tasks/editorial-review-prose.md`
- Output lane: `report located with target document`
- Expected outputs: three-column markdown table with suggested fixes
- Summary: Review prose for clarity, tone, and communication issues. Use after drafting to polish written content.
