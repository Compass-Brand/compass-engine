...
description: "Validate the PRD for completeness, cohesion, and readiness for the WDS lane."
---

# /bmad-bmm-validate-prd

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-bmm-validate-prd`.
...
- Phase: `2-planning`
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/2-plan-workflows/create-prd/workflow-validate-prd.md`
- Preferred agent: John (Product Manager)
- Mode / options: Validate Mode
- Output lane: `current_prd_dir`
- Expected outputs: prd validation report|gate package
- Summary: Validate the PRD for completeness, cohesion, and readiness for the WDS lane.
