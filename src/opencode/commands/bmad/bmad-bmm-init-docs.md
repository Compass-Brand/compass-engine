---
name: bmad-bmm-init-docs
description: "Migrate existing documentation into Compass opinionated docs structure while preserving legacy docs in dated migration snapshots."
---

# /bmad-bmm-init-docs

Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-bmm-init-docs`.
...
- Phase: `anytime`
- Module: `bmm`
- Workflow: `_bmad/modules/custom/bmm/workflows/documentation/init-docs/workflow.yaml`
- Preferred agent: Mary (Business Analyst)
- Mode / options: Create Mode
- Output lane: `docs_root`
- Expected outputs: docs initialization report|migration manifest
- Summary: Migrate existing documentation into Compass opinionated docs structure while preserving legacy docs in dated migration snapshots.
