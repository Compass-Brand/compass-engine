...
Use this OpenCode command to invoke the Compass BMAD workflow entry point for `bmad-help`.
...
- Phase: `anytime`
- Module: `core`
- Workflow: `_bmad/modules/custom/core/tasks/help.md`
- Summary: Get unstuck by showing what workflow steps come next or answering BMad Method questions.
