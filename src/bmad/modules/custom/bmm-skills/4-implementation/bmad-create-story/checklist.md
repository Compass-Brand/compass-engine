...
- The `{project-root}/_bmad/modules/custom/core/tasks/workflow.xml` framework will automatically:
...
3. **Load validation framework**: `{project-root}/_bmad/modules/custom/core/tasks/workflow.xml`
