...
# File References
nextStepFile: '{project-root}/_bmad/modules/custom/bmm/workflows/2-plan-workflows/create-prd/steps-c/step-07-project-type.md'
outputFile: '{current_prd_dir}/prd.md'

# Data Files
projectTypesCSV: '{project-root}/_bmad/modules/custom/bmm/workflows/2-plan-workflows/create-prd/data/project-types.csv'
