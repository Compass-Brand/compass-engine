...
- Read fully and follow: {project-root}/_bmad/modules/custom/core/workflows/advanced-elicitation/workflow.xml with the current UX patterns content
...
- Read fully and follow: {project-root}/_bmad/modules/custom/core/workflows/party-mode/workflow.md with the current UX patterns
...
- Load `{project-root}/_bmad/modules/custom/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-13-responsive-accessibility.md`
...
After user selects 'C' and content is saved to document, load `{project-root}/_bmad/modules/custom/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-13-responsive-accessibility.md` to define responsive design and accessibility strategy.
