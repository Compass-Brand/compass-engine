...
- Read fully and follow: {project-root}/_bmad/modules/custom/core/workflows/advanced-elicitation/workflow.xml with the current user journey content
...
- Read fully and follow: {project-root}/_bmad/modules/custom/core/workflows/party-mode/workflow.md with the current user journeys
...
- Load `{project-root}/_bmad/modules/custom/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-11-component-strategy.md`
