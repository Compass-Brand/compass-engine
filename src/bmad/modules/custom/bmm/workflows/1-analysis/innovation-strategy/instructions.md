...
<critical>You MUST have already loaded and processed: {project-root}/_bmad/modules/custom/bmm/workflows/1-analysis/innovation-strategy/workflow.yaml</critical>
