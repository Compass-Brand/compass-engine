...
# File References
nextStepFile: '{project-root}/_bmad/modules/custom/bmm/workflows/1-analysis/create-product-brief/steps/step-02-vision.md'
...
- **STOP immediately** and load `{project-root}/_bmad/modules/custom/bmm/workflows/1-analysis/create-product-brief/steps/step-01b-continue.md`
