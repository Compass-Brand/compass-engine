...
Actions:
- `a`: run `{project-root}/_bmad/modules/custom/core/workflows/advanced-elicitation/workflow.md`
- `c`: continue to next instruction
- `o`: run `{project-root}/_bmad/modules/custom/core/workflows/autonomous-refinement-loop/workflow.md`
- `p`: run `{project-root}/_bmad/modules/custom/core/workflows/party-mode/workflow.md`
