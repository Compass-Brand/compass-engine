...
standalone: false
advanced_elicitation_methods: "{project-root}/_bmad/modules/custom/core/workflows/advanced-elicitation/methods.csv"
...
- Load config from `{project-root}/_bmad/modules/custom/core/config.yaml`.
...
- Select a diverse set of 3-5 methods from `{advanced_elicitation_methods}`.
