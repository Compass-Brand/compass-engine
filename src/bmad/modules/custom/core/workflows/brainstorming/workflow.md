...
Load config from `{project-root}/_bmad/modules/custom/core/config.yaml` and resolve:
...
- `installed_path` = `{project-root}/_bmad/modules/custom/core/workflows/brainstorming`
