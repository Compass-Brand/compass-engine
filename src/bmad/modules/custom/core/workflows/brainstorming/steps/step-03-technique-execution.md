...
---
advancedElicitationTask: '{project-root}/_bmad/modules/custom/core/workflows/advanced-elicitation/workflow.md'
---
...
- **Append the technique execution content to `{roadmap_brainstorming_dir}/brainstorming-session-{{date}}.md`**
...
When user selects 'C', append the content directly to `{roadmap_brainstorming_dir}/brainstorming-session-{{date}}.md` using the structure from above.
