...
- Look for file at `{roadmap_brainstorming_dir}/brainstorming-session-{{date}}.md`
...
mkdir -p "$(dirname "{roadmap_brainstorming_dir}/brainstorming-session-{{date}}.md")"

# Initialize from template
cp "{template_path}" "{roadmap_brainstorming_dir}/brainstorming-session-{{date}}.md"
```
...
When user selects approach, append the session overview content directly to `{roadmap_brainstorming_dir}/brainstorming-session-{{date}}.md` using the structure from above.
...
- **Append initial session overview to `{roadmap_brainstorming_dir}/brainstorming-session-{{date}}.md`**
