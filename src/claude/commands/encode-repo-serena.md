...
description: Systematically populate the Forgetful knowledge base using Serena LSP-powered symbol analysis for comprehensive codebase understanding
---
...
mcp__context7__get-library-docs({
  ...
  "topic": "Depends pattern for request validation"
})
```
