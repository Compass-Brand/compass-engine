# BMAD Automation Reference

Status: phase-6-reference-specs-landed
Owner:
Last Updated: 2026-03-13

This directory is the reference-stage home for Compass BMAD automation specs.

Automation here is still method definition work. It is not `src` runtime packaging yet.
These wrapper specs are intentionally not cataloged in `reference/BMAD/modules/custom/bmm/module-help.csv` yet because they are reference-stage orchestration contracts, not shipped runtime commands.
...
1. The canonical workflow stays in `reference/BMAD/BMAD-workflow.md`.
...
These files define the approved reference contract for automation. They do not yet:

- create runtime commands in `src/`
