...
- Agent manifest path: `{project-root}/reference/BMAD/_config/agent-manifest.csv`

### Paths

- `installed_path` = `{project-root}/reference/BMAD/modules/custom/core/workflows/party-mode`
