...
- Agent manifest CSV is available at `{project-root}/reference/BMAD/_config/agent-manifest.csv`
...
Load and parse the agent manifest CSV from `{project-root}/reference/BMAD/_config/agent-manifest.csv`
