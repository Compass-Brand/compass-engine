...
- **Append the final session content to `{roadmap_brainstorming_dir}/brainstorming-session-{{date}}.md`**
...
When user selects 'C', append the content directly to `{roadmap_brainstorming_dir}/brainstorming-session-{{date}}.md` using the structure from step 7.
