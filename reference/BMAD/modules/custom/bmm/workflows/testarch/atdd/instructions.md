...
**Workflow ID**: `reference/BMAD/modules/custom/bmm/testarch/atdd`
...
`{project-root}/reference/BMAD/modules/custom/bmm/workflows/testarch/atdd/steps-c/step-01-preflight-and-context.md`

### 3. Resume Support

If the user selects **Resume** mode, load, read completely, and execute:
`{project-root}/reference/BMAD/modules/custom/bmm/workflows/testarch/atdd/steps-c/step-01b-resume.md`
