...
**Workflow ID**: `reference/BMAD/modules/custom/bmm/testarch/framework`
...
`{project-root}/reference/BMAD/modules/custom/bmm/workflows/testarch/framework/steps-c/step-01-preflight.md`

### 3. Resume Support

If the user selects **Resume** mode, load, read completely, and execute:
`{project-root}/reference/BMAD/modules/custom/bmm/workflows/testarch/framework/steps-c/step-01b-resume.md`
