...
<critical>You MUST have already loaded and resolved: {project-root}/reference/BMAD/modules/custom/bmm/workflows/documentation/update-docs/workflow.yaml</critical>
