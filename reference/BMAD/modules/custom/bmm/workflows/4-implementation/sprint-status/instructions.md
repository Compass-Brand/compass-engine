...
<critical>You MUST have already loaded and processed: {project-root}/reference/BMAD/modules/custom/bmm/workflows/4-implementation/sprint-status/workflow.yaml</critical>
