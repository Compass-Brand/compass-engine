...
- The `{project-root}/reference/BMAD/modules/custom/core/tasks/workflow.xml` framework will automatically:
...
3. **Load validation framework**: `{project-root}/reference/BMAD/modules/custom/core/tasks/workflow.xml`
