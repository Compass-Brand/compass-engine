...
- `{project-root}/reference/BMAD/modules/custom/bmm/workflows/0-governance/security-activation.md`
- `{project-root}/reference/BMAD/modules/custom/bmm/workflows/4-implementation/secure-gates/secure-gate-criteria.yaml`
