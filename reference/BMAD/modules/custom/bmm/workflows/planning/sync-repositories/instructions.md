...
<critical>You MUST have already loaded and resolved: {project-root}/reference/BMAD/modules/custom/bmm/workflows/planning/sync-repositories/workflow.yaml</critical>
