...
workflow_path: '{project-root}/reference/BMAD/modules/custom/bmm/workflows/3-solutioning/security-architecture-review'
...
brainstormingTask: '{project-root}/reference/BMAD/modules/custom/core/tasks/brainstorming.xml'
