...
Load, read the full file and then follow `{project-root}/reference/BMAD/modules/custom/bmm/workflows/3-solutioning/threat-modeling/steps/step-01-init.md` to begin the workflow.
