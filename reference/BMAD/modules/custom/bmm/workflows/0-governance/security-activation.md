...
- threat models: `reference/planning/framework/current/planning/architecture/threat-modeling/`
- security reviews: `reference/planning/framework/current/planning/architecture/security-review/`
- secure readiness gate drafts: `reference/planning/framework/current/testing/gates/draft/security/`
- approved secure readiness gate reports: `reference/planning/framework/current/testing/gates/security/readiness/`
- secure release gate reports: `reference/planning/framework/current/testing/gates/security/release/`
