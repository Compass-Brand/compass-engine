...
- instantiated files in `reference/planning/framework/` are authoritative over `reference/planning/templates/`
...
- project-specific roadmap, phase, automation runtime, and gate artifacts do not promote into `src/`
