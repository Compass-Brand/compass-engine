...
1. `reference/documentation/human/policies/` defines the human-doc requirements.
2. `reference/documentation/human/templates/` operationalizes those requirements.
...
## Authoring Versus Deployment

Inside `compass-engine`:

- `reference/documentation/` is the canonical documentation framework source.
- `reference/BMAD/` is the current BMAD authoring workspace.
- `reference/planning/` is the current planning framework source.
...
The BMAD method should therefore read standards from `reference/documentation/` here, but write project documentation into `docs/`.
...
- BMAD docs workflows must read standards from `reference/documentation/`, not a stale copy.
